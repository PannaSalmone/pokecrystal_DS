...
TilesetGardenGFX::
INCBIN "gfx/tilesets/garden.2bpp.lz"

TilesetGardenMeta::
INCBIN "data/tilesets/garden_metatiles.bin"

TilesetGardenColl::
INCLUDE "data/tilesets/garden_collision.asm"
...
TilesetGardenAttr::
INCBIN "data/tilesets/garden_attributes.bin"
