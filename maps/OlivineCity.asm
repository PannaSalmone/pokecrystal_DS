...
OlivineCityLassText:
	...
	para "you can't enjoy the"
	line "ocean with all the"
	cont "noise in there."
	done
...
OlivineCity_MapEvents:
	...
	warp_event 19, 29, OLIVINE_PORT_PASSAGE, 1
	warp_event 20, 29, OLIVINE_PORT_PASSAGE, 2
	...
	bg_event 32, 24, BGEVENT_READ, OlivineLighthouseSign
	bg_event  3, 21, BGEVENT_READ, OlivineCityBattleTowerSign
	bg_event 14, 21, BGEVENT_READ, OlivineCityPokecenterSign
	bg_event 22, 17, BGEVENT_READ, OlivineCityMartSign

	def_object_events
	object_event 24, 25, SPRITE_SAILOR, SPRITEMOVEDATA_WALK_UP_DOWN, 0, 1, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, OlivineCitySailor1Script, -1
	...
	object_event 10, 19, SPRITE_LASS, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, PAL_NPC_RED, OBJECTTYPE_SCRIPT, 0, OlivineCityLassScript, -1
